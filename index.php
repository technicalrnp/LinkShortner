...
function ShortURL($url)
{
    ...
    $short_url = uniqid();
    $query = "INSERT INTO $TABLE(base_url,redirect_url) VALUE('$url','$short_url')";
    $result = mysqli_query($con, $query) or die(mysqli_error($con));
    $actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]?s=";
    return $actual_link . $short_url;
}
...
function RedirectURL($url)
{
    ...
    $query = "SELECT base_url from $TABLE where redirect_url = '$url'";
    $result = mysqli_query($con, $query) or die(mysqli_error($con));
...
<header id="header" class="menu-container" data-aos="fade-down">

    <!--   Logo -->
    <div class="logo-box" data-aos="fade-down" data-aos-delay="500">
        ...
        <h1 class="logo_text">SHORT INFINITY</h1>
    </div>
    <!--   Logo -->
    ...
    <nav id="nav-bar">
        <ul class="menu">
            <li><a href="#about" class="nav-link" data-aos="fade-down" data-aos-delay="300">About</a></li>
            <a class="highlight" href="#" data-aos="fade-down" data-aos-delay="500">Getting Started</a>
        </ul>
    </nav>
    <!--   navbar -->
</header>
...
<main class="container" data-aos="fade-down">
    <section class="hero container">
        <h1 class="hero-title-primary" data-aos="fade-down"  data-aos-delay="200">URL Shortner</h1>
        <p class="hero-title-sub" data-aos="fade-down"  data-aos-delay="400">Fastest Way to Make Short URL !!</p>
        ...
        <form action="" method="POST" autocomplete="off">
            ...
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                $default_url = ShortURL($_REQUEST['user_url']);
                $copy_toggle = "inline";
            }

            if (isset($_REQUEST['s'])) {
                RedirectURL($_REQUEST['s']);
            }

            ?>
            <input data-aos="fade-in-down"  data-aos-delay="700" type="url" name="user_url" class="user_url" id="url_input" value="<?php echo $default_url  ?>" placeholder=" https://google.com" required /> <br> <br>

            <button type="submit" data-aos="zoom-in-down" data-aos-delay="800">Generate Short URL</button>
            <button type="button"  data-aos="zoom-in-down" data-aos-delay="900" style="display:<?php echo $copy_toggle  ?>" onclick="copyURL()">Copy URL</button>
        ...
        Swal.fire({
            title: 'Copied!',
            text: "Your Short URL has been copied to clipboard",
            icon: 'success',
    ...
    <div class="hero-image" data-aos="fade-down-left" data-aos-delay="500">
        <figure>
            <svg viewBox="0 0 609 612" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M89.76 377.196C91.5807 370.265 105.708 377.833 104.836 381.154C103.963 384.474 87.8169 384.622 89.76 377.196Z" fill="black" />
                <path d="M89.5203 401.65C88.6278 394.541 104.555 396.306 104.983 399.712C105.412 403.119 90.474 409.265 89.5203 401.65Z" fill="black" />
...
<section class="content">
    ...
    <div class="inner-content" id="about">
        <div class="inner-content-text content__TextLeft" data-aos="fade-down-right" data-aos-delay="100">
            ...
            <div class="inner-content-para">
                <p>A URL shortener is a tool that creates a short, unique URL that will redirect to the specific website of your choosing. Basically: they make a URL shorter and simpler. Your new, shorter URL will typically include the shortener site's address, plus a combination of random letters.</p>
            </div>
        </div>

        <div class="inner-image-container container__ImageRight">
            <div class="inner-content-image content__ImageRight">
                <img  data-aos="fade-down-left" data-aos-delay="200" class="section-images" src="images/1.jpeg" style="object-position: 50% 50%;">
            </div>
        </div>
    </div>
